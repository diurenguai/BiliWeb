<template>
    <div class="detail-nav-header">
        <navigateCo class="navigator-navigate"
            :navigateItem="data.navigateItem"></navigateCo>
            <searchCo class="navigator-search"></searchCo>
            <navigateCo class="navigator-navigate2"
            :navigateItem="data.navRightList">
            <template v-slot:nav-item>
            <!-- <avatarCo class="avatar"></avatarCo> -->
            <btnLog></btnLog>
        </template>
        </navigateCo>
    </div>
...
import searchCo from '../homeCom/search.vue'
import navigateCo from '../homeCom/navigate.vue'
import btnLog from '../btn/btnLog.vue'
import { reactive } from 'vue';
export default {
    name: 'homeNav',
    components: {
        searchCo,navigateCo,btnLog
    },
    setup()
    {
        const data = reactive({
